                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-red-500 to-red-600 sm:px-10 xl:p-12">
                                    ...
                                    <dl className="mt-8 space-y-6">
                                        ...
                                        <dd className="flex text-base text-teal-50">
                                            ...
                                            <span className="ml-3">0836-2258073, +91-9886786817</span>
                                        </dd>
                                        <dt>
                                        ...
                                        <dd className="flex text-base text-teal-50">
                                            ...
                                            <span className="ml-3">altaj.contact@gmail.com</span>
                                        </dd>
                                    </dl>
                        ...
                        />
                                        ...
                                        <div className="sm:col-span-2 sm:flex sm:justify-end">
                                            <button
                                                type="submit"
                                                className="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:w-auto"
                                            >
                                                Submit
                                            </button>
                                        </div>
