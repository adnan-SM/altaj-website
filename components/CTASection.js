                    ...
                    <div className="relative bg-gray-800 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                        <div className="hidden absolute inset-0 overflow-hidden rounded-3xl lg:block" aria-hidden="true">
                            ...
                            >
                                <defs>
                                    ...
                                    >
                                        <rect x={0} y={0} width={4} height={4} className="text-pink-400" fill="currentColor" />
                                    </pattern>
                                </defs>
                        ...
                        <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                            ...
                            <p className="text-lg text-white">
                                Enjoy the comfort of ordering delicious food right from the app.
                            </p>
                            <a
                                ...
                                href="https://play.google.com/store/apps/details?id=com.altaf.altajapp&hl=en&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"
                                target="_blank"
                            >
                                Download Now
                            </a>
